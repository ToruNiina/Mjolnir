#ifndef MJOLNIR_INTERACTION_GLOBAL_PAIR_WCA_INTEARACTION_HPP
#define MJOLNIR_INTERACTION_GLOBAL_PAIR_WCA_INTEARACTION_HPP
...
// It is a specialization of GlobalPairInteraction for WCA.
// In the case of WCA, we can omit `sqrt` call that is
...
class GlobalPairInteraction<
    ...
    WCAPotential<SimulatorTraits<realT, boundaryT>>
    > final : public GlobalInteractionBase<SimulatorTraits<realT, boundaryT>>
{
  public:
    ...
    using potential_type  = WCAPotential<traits_type>;
  ...
  public:
    ...
    std::string name() const override {return "GlobalPairWCA";}
...
{
// L-J
extern template class GlobalPairInteraction<SimulatorTraits<double, UnlimitedBoundary>,        WCAPotential<SimulatorTraits<double, UnlimitedBoundary>       >>;
extern template class GlobalPairInteraction<SimulatorTraits<float,  UnlimitedBoundary>,        WCAPotential<SimulatorTraits<float,  UnlimitedBoundary>       >>;
extern template class GlobalPairInteraction<SimulatorTraits<double, CuboidalPeriodicBoundary>, WCAPotential<SimulatorTraits<double, CuboidalPeriodicBoundary>>>;
extern template class GlobalPairInteraction<SimulatorTraits<float,  CuboidalPeriodicBoundary>, WCAPotential<SimulatorTraits<float,  CuboidalPeriodicBoundary>>>;
} // mjolnir

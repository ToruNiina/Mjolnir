#ifndef MJOLNIR_OMP_GLOBAL_PAIR_WCA_INTEARACTION_HPP
#define MJOLNIR_OMP_GLOBAL_PAIR_WCA_INTEARACTION_HPP
...
// specialization for GlobalPair<WCA>
template<typename realT, template<typename, typename> class boundaryT>
class GlobalPairInteraction<
    OpenMPSimulatorTraits<realT, boundaryT>,
    WCAPotential<OpenMPSimulatorTraits<realT, boundaryT>>
...
namespace mjolnir
{
extern template class GlobalPairInteraction<OpenMPSimulatorTraits<double, UnlimitedBoundary>       , WCAPotential<OpenMPSimulatorTraits<double, UnlimitedBoundary>       >>;
extern template class GlobalPairInteraction<OpenMPSimulatorTraits<float,  UnlimitedBoundary>       , WCAPotential<OpenMPSimulatorTraits<float,  UnlimitedBoundary>       >>;
extern template class GlobalPairInteraction<OpenMPSimulatorTraits<double, CuboidalPeriodicBoundary>, WCAPotential<OpenMPSimulatorTraits<double, CuboidalPeriodicBoundary>>>;
extern template class GlobalPairInteraction<OpenMPSimulatorTraits<float,  CuboidalPeriodicBoundary>, WCAPotential<OpenMPSimulatorTraits<float,  CuboidalPeriodicBoundary>>>;
} // mjolnir

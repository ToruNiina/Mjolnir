#ifndef MJOLNIR_OMP_NONDET_BAOAB_LANGEVIN_INTEGRATOR_HPP
#define MJOLNIR_OMP_NONDET_BAOAB_LANGEVIN_INTEGRATOR_HPP
...
class BAOABLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<realT, boundaryT>>
{
  public:
...
extern template class BAOABLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<double, UnlimitedBoundary>>;
extern template class BAOABLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<float,  UnlimitedBoundary>>;
extern template class BAOABLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>>;
extern template class BAOABLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>>;
#endif

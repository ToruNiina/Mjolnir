#ifndef MJOLNIR_OMP_NONDET_PERIODIC_GRID_CELL_LIST_HPP
#define MJOLNIR_OMP_NONDET_PERIODIC_GRID_CELL_LIST_HPP
...
template<typename realT, template<typename, typename> class boundaryT,
         typename potentialT>
class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<realT, boundaryT>, potentialT>
    final : public SpatialPartitionBase<OpenMPNonDeterministicSimulatorTraits<realT, boundaryT>, potentialT>
{
  public:
...
namespace mjolnir
{
extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>, DebyeHuckelPotential<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>>>;
extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>, DebyeHuckelPotential<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>>>;

extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>, ExcludedVolumePotential<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>>>;
extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>, ExcludedVolumePotential<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>>>;

extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>, LennardJonesPotential<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>>>;
extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>, LennardJonesPotential<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>>>;

extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>, UniformLennardJonesPotential<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>>>;
extern template class PeriodicGridCellList<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>, UniformLennardJonesPotential<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>>>;
}

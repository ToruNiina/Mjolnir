#ifndef MJOLNIR_OMP_NONDET_RANDOM_NUMBER_GENERATOR
#define MJOLNIR_OMP_NONDET_RANDOM_NUMBER_GENERATOR
...
class RandomNumberGenerator<OpenMPNonDeterministicSimulatorTraits<realT, boundaryT>>
{
  public:
...
RandomNumberGenerator<OpenMPNonDeterministicSimulatorTraits<realT, boundaryT>>::cache_alignment;

#ifdef MJOLNIR_SEPARATE_BUILD
extern template class RandomNumberGenerator<OpenMPNonDeterministicSimulatorTraits<double, UnlimitedBoundary>>;
extern template class RandomNumberGenerator<OpenMPNonDeterministicSimulatorTraits<float,  UnlimitedBoundary>>;
extern template class RandomNumberGenerator<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>>;
extern template class RandomNumberGenerator<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>>;
#endif

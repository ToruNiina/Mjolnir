#ifndef MJOLNIR_OMP_NONDET_UNDERDAMPED_LANGEVIN_INTEGRATOR
#define MJOLNIR_OMP_NONDET_UNDERDAMPED_LANGEVIN_INTEGRATOR
...
class UnderdampedLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<realT, boundaryT>>
{
  public:
...
extern template class UnderdampedLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<double, UnlimitedBoundary>>;
extern template class UnderdampedLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<float,  UnlimitedBoundary>>;
extern template class UnderdampedLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<double, CuboidalPeriodicBoundary>>;
extern template class UnderdampedLangevinIntegrator<OpenMPNonDeterministicSimulatorTraits<float,  CuboidalPeriodicBoundary>>;
#endif

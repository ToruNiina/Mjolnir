#ifndef MJOLNIR_OMP_NONDET_UNLIMITED_GRID_CELL_LIST_HPP
#define MJOLNIR_OMP_NONDET_UNLIMITED_GRID_CELL_LIST_HPP
#include <mjolnir/omp_nondet/OpenMPNonDeterministicSimulatorTraits.hpp>
#include <mjolnir/omp/sort.hpp> // XXX
...
class UnlimitedGridCellList<OpenMPNonDeterministicSimulatorTraits<realT, boundaryT>, potentialT>

#define BOOST_TEST_MODULE "test_global_pair_wca_interaction"
...
BOOST_AUTO_TEST_CASE(GlobalPairWCAInteraction_numeric_limits)
{
    mjolnir::LoggerManager::set_default_logger("test_global_pair_wca_interaction.log");
    ...
    using potential_type   = mjolnir::WCAPotential<traits>;
...
BOOST_AUTO_TEST_CASE(GlobalPairWCAInteraction_numeric_force_and_energy)
{
    mjolnir::LoggerManager::set_default_logger("test_global_pair_wca_interaction.log");
    using traits = mjolnir::SimulatorTraits<double, mjolnir::UnlimitedBoundary>;

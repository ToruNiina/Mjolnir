#define BOOST_TEST_MODULE "test_omp_global_pair_wca_interaction"
...
BOOST_AUTO_TEST_CASE(omp_GlobalPair_WCA_calc_force)
{
    constexpr double tol = 1e-8;
    mjolnir::LoggerManager::set_default_logger("test_omp_global_pair_wca_interaction.log");
    ...
    using sequencial_potential_type   = mjolnir::WCAPotential<sequencial_traits_type>;
...
BOOST_AUTO_TEST_CASE(omp_GlobalPair_WCA_calc_force_and_energy)
{
    mjolnir::LoggerManager::set_default_logger("test_omp_global_pair_wca_interaction.log");
